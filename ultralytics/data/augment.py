...
from ultralytics.data.utils import polygons2masks, polygons2masks_overlap, zzh_polygons2masks_overlap
...
class Format:
    ...
    def _format_segments(self, instances, cls, w, h):
        ...
        if self.mask_overlap:
            masks, sorted_idx = zzh_polygons2masks_overlap((h, w), segments, cls, downsample_ratio=self.mask_ratio) #zzh
            # masks, sorted_idx = polygons2masks_overlap((h, w), segments, downsample_ratio=self.mask_ratio) #zzh
